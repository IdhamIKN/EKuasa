                    ...
                    <form method="GET" action="{{ route('admin.dashboard') }}" class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="search" name="search"
                                   value="{{ request('search') }}" placeholder="Cari berdasarkan nama, NIK, atau ID">
                        </div>
                        <div class="col-md-2">
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                @forelse($suratKuasas as $surat)
                                <tr>
                                    <td>
                                        <small class="font-monospace">{{ Str::limit($surat->id, 8) }}</small>
                                    </td>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="{{ route('admin.show', $surat->id) }}"
                                            ...
                                            @if($surat->status === 'pending')
                                                <button type="button" class="btn btn-sm btn-outline-success"
                                                        onclick="showApproveModal('{{ $surat->id }}')" title="Setujui">
                                                    <i class="fas fa-check"></i>
                                                </button>
                                                <button type="button" class="btn btn-sm btn-outline-danger"
                                                        onclick="showRejectModal('{{ $surat->id }}')" title="Tolak">
                                                    <i class="fas fa-times"></i>
                                                </button>
                                            @endif

                                            @if($surat->pdf_file)
                                                <a href="{{ route('admin.surat-kuasa.download', $surat->id) }}"
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="alasan_penolakan" name="alasan_penolakan" rows="4"
                                  placeholder="Contoh: Foto KTP tidak jelas, data tidak lengkap, dll." required></textarea>
                    </div>
